...
.PHONY: setup install install-dev install-gpu test test-contracts lint clean preflight demo demo-list hyperframes-doctor hyperframes-warm mcp mcp-inspector
...
mcp:
	@echo "==> Installing OpenMontage MCP server..."
	$(PYTHON) -m pip install -e ".[mcp]"
	@echo "==> Done. Run: python -m openmontage_mcp.server"

mcp-inspector:
	@echo "==> Starting MCP Inspector..."
	npx @anthropics/mcp-inspector -- $(PYTHON) -m openmontage_mcp.server --project-dir .
