...
<h1 align="center">OpenMontage 中文 MCP 版</h1>

<p align="center"><strong>首个开源的、代理化（agentic）的视频制作系统 —— 中文界面 + MCP Server + 国内大模型友好</strong></p>

<p align="center">
  <a href="#这是什么版本">这是什么版本</a> &nbsp;·&nbsp;
  <a href="#快速开始">快速开始</a> &nbsp;·&nbsp;
  <a href="#mcp-server">MCP Server</a> &nbsp;·&nbsp;
  <a href="#中文配置向导">中文配置向导</a> &nbsp;·&nbsp;
  <a href="#流水线">流水线</a> &nbsp;·&nbsp;
  <a href="#智能体兼容性">智能体兼容性</a>
</p>

<p align="center">
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-AGPLv3-blue.svg" alt="License"></a>
  <a href="https://github.com/noah-1106/openmontage-zh-mcp"><img src="https://img.shields.io/badge/仓库-openmontage--zh--mcp-0b1220?style=flat&logo=github" alt="openmontage-zh-mcp"></a>
</p>
...
本仓库是基于 [calesthio/OpenMontage](https://github.com/calesthio/OpenMontage) 的**中文 MCP 适配版**，保留原项目 AGPL-3.0 协议，主要改进：
...
1. **首先阅读契约**
   从 [`AGENT_GUIDE_zh-CN.md`](AGENT_GUIDE_zh-CN.md) 开始，然后是 [`PROJECT_CONTEXT_zh-CN.md`](PROJECT_CONTEXT_zh-CN.md)。
2. **不要擅自虚构制作工作流**
...
我们提供了交互式中文配置向导，支持 LLM、图像、视频、TTS、音乐、素材库等主流国内外服务商一键配置：
...
- 交互式选择并填写 API Key
- 自动写入项目根目录的 `.env` 文件
- 将 LLM 选择同步写入 `config.yaml`

支持的大模型/服务包括：

| 类型 | 已支持 |
|------|--------|
| **LLM** | Anthropic Claude、OpenAI / 兼容端点、DeepSeek、通义千问、智谱 GLM、Moonshot、百川、OpenRouter、Ollama 本地 |
| **图像生成** | fal.ai (FLUX / Seedance / Recraft)、OpenAI DALL·E、Google Imagen、通义万相、智谱 CogView、百度文心一格 |
| **视频生成** | fal.ai (Kling / Veo / MiniMax / Seedance)、MiniMax 海螺、可灵 Kling、通义万相视频、智谱 CogVideo、Runway、HeyGen、本地 LTX/CogVideo |
| **语音合成 (TTS)** | ElevenLabs、Google Cloud TTS、OpenAI TTS、豆包、通义听悟、百度智能云、Piper 本地 |
| **音乐** | Suno、ElevenLabs Music |
| **素材库** | Pexels、Pixabay、Unsplash |

> **国内模型注意：** 多数国内 LLM（DeepSeek、通义千问、智谱、Moonshot、百川）通过 OpenAI 兼容端点接入，向导会自动写入对应 `BASE_URL`。视频/音频/图像模型则按各自官方 API key 填写。

如果你更喜欢手动配置，可直接编辑项目根目录的 `.env`：
...
所有平台的指令文件都指向共享的 [`AGENT_GUIDE_zh-CN.md`](AGENT_GUIDE_zh-CN.md)（操作指南和智能体契约）与 [`PROJECT_CONTEXT_zh-CN.md`](PROJECT_CONTEXT_zh-CN.md)（架构参考）。

> **中文文档入口：** [`AGENT_GUIDE_zh-CN.md`](AGENT_GUIDE_zh-CN.md) · [`PROJECT_CONTEXT_zh-CN.md`](PROJECT_CONTEXT_zh-CN.md) · [`README_zh-CN.md`](README_zh-CN.md)
...
详见 `docs/ARCHITECTURE.md` 获取完整的技术参考，`docs/PROVIDERS.md` 查看完整的提供商指南（设置、定价、免费额度），以及 [`AGENT_GUIDE_zh-CN.md`](AGENT_GUIDE_zh-CN.md) 了解智能体契约。
